    ...
    <nav className="flex justify-between items-center pt-8 h-12 bg-white text-black relative">
      <div className="pl-4 md:pl-32 flex md:flex-row md:items-center">
        ...
        <div className="hidden md:flex md:flex-row">
          <div className="p-4 cursor-pointer text-x-gray-violet font-bold hover:text-x-very-dark-violet">
            Features
          </div>
          <div className="p-4 cursor-pointer text-x-gray-violet font-bold hover:text-x-very-dark-violet">
            Pricing
      ...
      <div className="md:pr-32 hidden md:flex md:flex-row items-center ">
        ...
        <button
          type="button"
          className="p-4 text-white font-bold bg-x-cyan hover:bg-cyan-300 rounded-full text-sm px-5 py-2.5 text-center"
        >
          Sign&#x2011;Up{' '}
          {/*<------- &#x2011; prevent line breaks used with hyphenated words  */}
        </button>
      </div>

      {/** Hamburger Icon */}
      <div
        className="pr-4 cursor-pointer text-x-gray md:hidden"
        onClick={() => setNavMenuShown(!navMenuShown)}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6 text-x-gray-violet"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
        >
      ...
      >
        ...
        <div className="pb-8">
          ...
          <button
            type="button"
            className="p-4 w-full  text-white font-bold bg-x-cyan rounded-full text-sm px-5 py-2.5 text-center"
          >
            Sign&#x2011;Up{' '}
            {/*<------- &#x2011; prevent line breaks used with hyphenated words  */}
          </button>
