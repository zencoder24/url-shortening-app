...
function Footer() {
  return (
    <section className=" bg-x-very-dark-violet px-0 py-12 md:px-32 md:py-20">
      <div className="flex flex-col gap-8 items-center md:flex-row md:items-start md: justify-between">
        <div>
          <BrandLogo className="fill-white w-24 md:w-24" />
        </div>
        <div className="text-center flex flex-col gap-4 md:text-left">
          ...
          <div className="flex flex-col gap-2 md:text-left">
            <p className="text-x-medium-gray hover:text-x-cyan cursor-pointer">
              Link Shortening
            </p>
            <p className="text-x-medium-gray hover:text-x-cyan cursor-pointer">
              Branded Links
        ...
        <div className=" mt-6 flex items-center justify-center gap-6 md:mt-1 flex-wrap">
