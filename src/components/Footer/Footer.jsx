...
function Footer() {
  ...
  return (
    <section className=" bg-x-very-dark-violet px-0 py-12 md:px-16 md:py-20">
      <div className="flex flex-col gap-8 items-center md:flex-row md:align-top md:items-start md: justify-around">
        ...
        <div className=' mt-6 flex items-center justify-center gap-6 md:mt-0'>
